    ...
    <div className="grid gap-3">
      <div className="grid gap-1.5">
        ...
        <p className="text-xs text-muted-foreground">
          Package ID from the URL — <code>play.google.com/store/apps/details?id=</code>
...
function ItemRenderer({ item }: ItemRendererProps<PlayReviewsItemMeta>) {
  return <ReviewItem item={item} badgeLabel="Google Play" badgeColor="rgba(52, 168, 83, 0.18)" />;
}
