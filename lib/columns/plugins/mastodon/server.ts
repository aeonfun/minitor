...
import { fetchMastodonHashtag, fetchMastodonAuthor } from "@/lib/integrations/mastodon";
import { sliceForPage } from "@/lib/columns/paginate";
import { meta, type MastodonConfig, type MastodonMeta } from "./plugin";

const fetch: ServerFetcher<MastodonConfig, MastodonMeta> = async (config, cursor) => {
